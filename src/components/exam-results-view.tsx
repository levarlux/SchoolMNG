...
/**
 * Exam results entry grid. Rendered as a full-page view on the static
 * /dashboard/exams route via the ?view=<examId> query param (dynamic
 * [id] routes can't be served with `output: export`).
 */
export function ExamResultsView({ examId }: { examId: string }) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={handleSave} disabled={saving}>
          {saving ? <BrandLoader variant="dots" size="sm" /> : <Save className="h-4 w-4 mr-2" />}
          Save Results
        </Button>
      </div>
